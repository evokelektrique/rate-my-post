...
class FeedbackWidget {
  constructor(widgetContainer, postID, rating, token, ratingID) {
    ...
    this.feedbackWidget = document.querySelector(
      this.widgetContainer + ".js-rmp-feedback-widget"
    );
  ...
  events() {
    ...
    this.submitButton.addEventListener("click", () => this.submitButtonClicked());
  }
